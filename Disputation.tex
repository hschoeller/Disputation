...
\centering
% try to make prettier, remove gray set and numbers
\only<1>{\includegraphics[scale=.5,  trim={24.6cm 7.9cm 10.2cm 4.5cm}, clip]{fig/20160502_00_3d.pdf}}
% smaller, remove numbers
\only<2->{
  \includegraphics[scale=.375,  trim={24.6cm 7.9cm 10.2cm 4.5cm}, clip]{fig/20160502_00_3d.pdf}
